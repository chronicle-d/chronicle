...
inline constexpr auto CHRONICLE_CONFIG_DEFUALT_KEX_METHODS =
    "curve25519-sha256@libssh.org,ecdh-sha2-nistp384,ecdh-sha2-nistp256,diffie-hellman-group14-sha256";
inline constexpr auto CHRONICLE_CONFIG_DEFUALT_HOSTKEYS =
    "ssh-ed25519,ecdsa-sha2-nistp521,ecdsa-sha2-nistp384,ecdsa-sha2-nistp256,rsa-sha2-512,rsa-sha2-256";
inline constexpr int CHRONICLE_CONFIG_DEFUALT_PORT = 22;
inline constexpr const char* CHRONICLE_CONFIG_DEFUALT_USER = "chronicle-runner";
inline constexpr int CHRONICLE_CONFIG_DEFUALT_VERBOSITY = 0;
